...
OUT_DIR_DEFAULT="/Volumes/Abhishek 5T/nfo_packed/options_date_packed_OLD5Y_v2_SORTED_NO_SPOT"
LOG_DEFAULT="newer data stocks/logs/old5y_repack.log"
...
while true; do
  clear
  echo "================================================================================"
  echo "OLD5Y OPTIONS REPACK - PROGRESS"
  echo "================================================================================"
  echo ""
